...
docExamples = [  
    ...
    % sonnetx.txt
    "textanalytics/ExtractTextDataFromTextFileExample"; 
    % weekendUpdates.xlsx
    "textanalytics/AnalyzeTextDataUsingEmojisExample";
    % bostemp.mat
    "signal/SignalSmoothingExample"; 
    % officetemp.mat
    "signal/DetermineCyclicBehaviorInDataExample";
];
